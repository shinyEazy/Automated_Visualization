...
def safe_read_file(file_path: str) -> str:
    ...
    try:
        ...
        try:
            ...
            # Final fallback - read as latin-1 (never fails)
...
class UIGenerator(dspy.Module):
    ...
    def forward(self, task_yaml_path: str):
        ...
        # Read curl command and response files with robust encoding
        try:
        ...
        api_integration = self.generate_api_integration(
            ...
            input_payload=input_payload[:250],
...
class AutoUIGenerator:
    ...
    def save(self, ui_html: str, output_dir: str, task_name: str):
        ...
        # Save output files with UTF-8 encoding and BOM to ensure compatibility
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\nHOW TO USE THE UI:")
        print("1. Open the HTML file in a modern browser")
        print("2. Note: The UI communicates directly with the model server")
        print("3. If the model server requires an API key, you'll need to:")
        print("   - Add an input field for the API key in the UI")
        print("   - Include the key in requests to the model server")
